...
class StatisticsPresenterTest {
    ...
    fun loadEmptyTasksFromRepository_CallViewToDisplay() {
        ...
        verify<StatisticsContract.View>(mStatisticsView).setProgressIndicator(true)
        ...
        verify<StatisticsContract.View>(mStatisticsView).setProgressIndicator(false)
        verify<StatisticsContract.View>(mStatisticsView).showStatistics(0, 0)
    }
    ...
    fun loadNonEmptyTasksFromRepository_CallViewToDisplay() {
        ...
        // Then progress indicator is hidden and correct data is passed on to the view
        verify<StatisticsContract.View>(mStatisticsView).setProgressIndicator(false)
        verify<StatisticsContract.View>(mStatisticsView).showStatistics(1, 2)
    }
    ...
    fun loadStatisticsWhenTasksAreUnavailable_CallErrorToDisplay() {
        ...
        verify<StatisticsContract.View>(mStatisticsView).showLoadingStatisticsError()
    }
