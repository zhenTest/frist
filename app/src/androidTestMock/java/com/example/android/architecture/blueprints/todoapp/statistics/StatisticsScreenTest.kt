...
class StatisticsScreenTest {
    ...
    fun intentWithStubbedTaskId() {
        ...
        FakeTasksRemoteDataSource.instance.addTasks(Task("Title1", "", false))
        FakeTasksRemoteDataSource.instance.addTasks(Task("Title2", "", true))
    ...
    fun Tasks_ShowsNonEmptyMessage() {
        ...
        val expectedActiveTaskText = InstrumentationRegistry.getTargetContext().getString(R.string.statistics_active_tasks)
        onView(withText(containsString(expectedActiveTaskText))).check(matches(isDisplayed()))
        val expectedCompletedTaskText = InstrumentationRegistry.getTargetContext().getString(R.string.statistics_completed_tasks)
